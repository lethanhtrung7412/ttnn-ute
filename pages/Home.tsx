      ...
      <div className="relative w-full h-[400px] md:h-[500px] overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col justify-center max-w-7xl">
          <div className="max-w-2xl text-white space-y-4 md:space-y-6 animate-fade-in-up">
            <span className="inline-block px-3 py-1 bg-secondary rounded-full text-[10px] md:text-xs font-bold tracking-wider uppercase">Thông báo mới nhất</span>
            <h1 className="text-3xl md:text-5xl font-bold leading-tight">Tuyển sinh các lớp ngoại ngữ đợt tháng 1/2026</h1>
            <p className="text-sm md:text-xl text-blue-100 opacity-90 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <a href="#" className="px-6 py-3 bg-white text-primary font-bold rounded shadow-lg hover:bg-gray-100 transition transform hover:-translate-y-1 text-center text-sm md:text-base">
                Đăng ký ngay
              </a>
              <a href="#" className="px-6 py-3 border-2 border-white text-white font-bold rounded hover:bg-white hover:text-primary transition text-center text-sm md:text-base">
                Xem chi tiết
              </a>
            </div>
          </div>
        </div>
        <button className="absolute left-2 md:left-4 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-full bg-white/20 hover:bg-white/40 text-white backdrop-blur-sm transition">
          <ChevronLeft size={20} />
        </button>
        <button className="absolute right-2 md:right-4 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-full bg-white/20 hover:bg-white/40 text-white backdrop-blur-sm transition">
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-3 space-y-8 md:space-y-12">
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-primary dark:text-white mb-6 flex items-center gap-2">
